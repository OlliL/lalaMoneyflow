...
{$HEADER}
		...
		<td align="center" valign="top">
			...
			{/section}
			<a href="javascript:void window.open('{$ENV_INDEX_PHP}?action=edit_user&amp;sr=1','_blank','width=230,height=300')">{#TEXT_29#}</a> 
			{if $COUNT_ALL_DATA > 0}
				<br><br>
				<table border=0>
					<tr>
						<th width="100">{#TEXT_85#}</th>
					...
					{section name=DATA loop=$ALL_DATA}
						<tr>
							...
							<td class="contrastbgcolor"><a href="javascript:void window.open('{$ENV_INDEX_PHP}?action=edit_user&amp;userid={$ALL_DATA[DATA].userid}&amp;sr=1','_blank','width=550,height=340,scrollbars=1')">{#TEXT_36#}</a></td>
