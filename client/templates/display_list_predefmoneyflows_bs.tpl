        ...
        <div class="container">
          ...
          <div class="text-center">
            ...
            <table style="margin: 0 auto;">
              <tr>
                <td>
                  <button class="btn btn-success" onClick="void window.open('{$ENV_INDEX_PHP}?action=edit_predefmoneyflow&amp;sr=1','_blank','width=600,height=520'); return false;">{#TEXT_29#}</button>
                  &nbsp;
                </td>
                <td>
                  <ul class="pagination">
...
{section name=DATA loop=$ALL_DATA}
              <tr>
                ...
                <td class="text-center"><a href="javascript:void window.open('{$ENV_INDEX_PHP}?action=edit_predefmoneyflow&amp;predefmoneyflowid={$ALL_DATA[DATA].predefmoneyflowid}&amp;sr=1','_blank','width=600,height=520')">{#TEXT_36#}</a></td>
