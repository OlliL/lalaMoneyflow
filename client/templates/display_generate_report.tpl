			...
			<table border=0 width=830 align="center" cellpadding=2>
				...
				{section name=DATA loop=$ALL_MONEYFLOW_DATA}
					<tr>
						...
						<td class="contrastbgcolor" align="center"><a href="javascript:void window.open('{$ENV_INDEX_PHP}?action=edit_moneyflow&id={$ALL_MONEYFLOW_DATA[DATA].id}&sr=1','_blank','width=1024,height=80')">{$TEXT_36}</a></td>
						<td class="contrastbgcolor" align="center"><a href="javascript:void window.open('{$ENV_INDEX_PHP}?action=delete_moneyflow&id={$ALL_MONEYFLOW_DATA[DATA].id}&sr=1','_blank','width=1024,height=80')">{$TEXT_37}</a></td>
					</tr>
				{/section}
