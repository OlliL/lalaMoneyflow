    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="input-group">
          ...
          <input id="email" type="text" class="form-control" name="name" placeholder="{#TEXT_85#}"
                 value="{$NAME}">
        </div>
        <br/>
        <div class="input-group">
          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
          <input id="password" type="password" class="form-control" name="password" placeholder="{#TEXT_86#}"
                 value="">
        </div>
        <br/>
        <app-error></app-error>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-12 controls text-center">
            <button type="submit" class="btn btn-primary"><i
              class="glyphicon glyphicon-log-in"></i> {#TEXT_88#}
            </button>
          </div>
        </div>
      </div>
