...
{$HEADER}
		...
		<form action="{$ENV_INDEX_PHP}" method="POST">
			...
			<table border=0>
				...
				<tr>
					<td class="contrastbgcolor"><input type="hidden" name="id" value="{$ALL_DATA.id}"><input class="contrastbgcolor" type="text" name="bookingdate" value="{$ALL_DATA.bookingdate}" size=10 /></td>
					<td class="contrastbgcolor"><input class="contrastbgcolor" type="text" name="invoicedate" value="{$ALL_DATA.invoicedate}" size=10 /></td>
					<td class="contrastbgcolor"><input class="contrastbgcolor" type="text" name="amount"     value="{$ALL_DATA.amount|string_format:"%.2f"}" size=8 /> EUR</td>
					<td class="contrastbgcolor"><select class="contrastbgcolor" name="capitalsourceid" size=1>
					...
					<td class="contrastbgcolor"><select class="contrastbgcolor" name="contractpartnerid" size=1>
					...
					<td class="contrastbgcolor"><input class="contrastbgcolor" type="text" name="comment" value="{$ALL_DATA.comment}" size="50"/></td>
				</tr>
			</table>
