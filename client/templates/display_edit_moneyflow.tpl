		...
		<form action="{$ENV_INDEX_PHP}" method="POST">
			...
			<table border=0>
				...
				<tr>
					...
					<td class="contrastbgcolor"><input class="contrastbgcolornobr" type="text" name="all_data[amount]"      value="{$ALL_DATA.amount|number_format}"    size=8  style="{if $ALL_DATA.amount_error == 1}color:red;{/if}text-align:right"> {#CURRENCY#}</td>
